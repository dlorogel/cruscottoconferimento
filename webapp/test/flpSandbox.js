		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cruscotto Conferimento",
									"targetURL": "#itorogelcruscottoconferimento-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itorogelcruscottoconferimento-display": {
								"semanticObject": "itorogelcruscottoconferimento",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=it.orogel.cruscottoconferimento",
									"url": sap.ui.require.toUrl("it/orogel/cruscottoconferimento")
								}
							}
						}
					}
